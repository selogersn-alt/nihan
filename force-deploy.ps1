...
$SSH_CMD = "cd /root/nihan-backend && git fetch origin && git reset --hard origin/main && docker compose down -v && docker compose build maison-nihan-backend && docker compose up -d && docker compose logs -f maison-nihan-backend"
